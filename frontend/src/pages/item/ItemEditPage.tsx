...
//
// File: src/pages/item/ItemEditPage.tsx
//
// Purpose: Permitir a alteração das informações e da imagem de
// itens previamente cadastrados.
// ============================================================================
...
function ItemEditPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await itemService.update(Number(id), formData);
      ...
      console.error(err);
      alert(err?.response?.data?.error ?? "Erro ao atualizar item.");
    }
  };
    ...
    <div className="container mt-4 frutiger-page">
      ...
      <div className="container mt-4 frutiger-page">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label className="form-label frutiger-label">Nova imagem</label>
